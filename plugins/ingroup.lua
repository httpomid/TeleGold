...
return {
  patterns = {"^([aA]dd)$","^([aA]dd) (realm)$","^([rR]em)$","^([rR]em) (realm)$","^([rR]ules)$","^([aA]bout)$","^([sS]etname) (.*)$","^([sS]etphoto)$","^([pP]romote) (.*)$","^([pP]romote)","^([hH]elp)$","^([cC]lean) (.*)$","^([kK]ill) (chat)$","^([kK]ill) (realm)$","^([dD]emote) (.*)$","^([dD]emote)","^([sS]et) ([^%s]+) (.*)$","^([lL]ock) (.*)$","^([sS]etowner) (%d+)$","^([sS]etowner)","^([oO]wner)$","^([rR]es) (.*)$","^([sS]etgpowner) (%d+) (%d+)$","^([uU]nlock) (.*)$","^([sS]etflood) (%d+)$","^([sS]ettings)$","^([pP]ublic) (.*)$","^([mM]odlist)$","^([nN]ewlink)$","^([lL]ink)$","^([Mm]ute) ([^%s]+)$","^([Uu]nmute) ([^%s]+)$","^([Mm]uteuser)$","^([Mm]uteuser) (.*)$","^([Mm]uteslist)$","^([Mm]utelist)$","^([kK]ickinactive)$","^([kK]ickinactive) (%d+)$","%[(document)%]","%[(photo)%]","%[(video)%]","%[(audio)%]","^!!tgservice (.+)$"},
  run = run,
